...
class BudgetViewModel(application: Application) : AndroidViewModel(application) {
    ...
    private val _budgetStatus = MutableStateFlow<List<BudgetStatus>>(emptyList())
    val budgetStatus: StateFlow<List<BudgetStatus>> = _budgetStatus
    ...
    private suspend fun updateBudgetStatuses(
        ...
        _budgetStatus.value = statusList
    }
